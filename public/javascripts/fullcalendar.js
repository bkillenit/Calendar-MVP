...
function hpadding(element) {
	return (parseFloat(jQuery.css(element[0], 'paddingLeft', true)) || 0) +
	       (parseFloat(jQuery.css(element[0], 'paddingRight', true)) || 0);
}


function hmargins(element) {
	return (parseFloat(jQuery.css(element[0], 'marginLeft', true)) || 0) +
	       (parseFloat(jQuery.css(element[0], 'marginRight', true)) || 0);
}


function hborders(element) {
	return (parseFloat(jQuery.css(element[0], 'borderLeftWidth', true)) || 0) +
	       (parseFloat(jQuery.css(element[0], 'borderRightWidth', true)) || 0);
}
...
function vpadding(element) {
	return (parseFloat(jQuery.css(element[0], 'paddingTop', true)) || 0) +
	       (parseFloat(jQuery.css(element[0], 'paddingBottom', true)) || 0);
}


function vmargins(element) {
	return (parseFloat(jQuery.css(element[0], 'marginTop', true)) || 0) +
	       (parseFloat(jQuery.css(element[0], 'marginBottom', true)) || 0);
}


function vborders(element) {
	return (parseFloat(jQuery.css(element[0], 'borderTopWidth', true)) || 0) +
	       (parseFloat(jQuery.css(element[0], 'borderBottomWidth', true)) || 0);
}
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		slotScroller =
			$("<div id='table-scroller' style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
				.appendTo(slotLayer);
